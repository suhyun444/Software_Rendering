...
public:
    ...
    static void DrawTriangle(BitmapBuffer &bitmapBuffer, const Vector3 &v1, const Vector3 &v2, const Vector3 &v3,float z1,float z2,float z3, PhongShader &phongShader, TextureMapping &textureMapping);
};