...
Index FaceValueToIndex(std::string input1,std::string input2,std::string input3)
{
    std::string x, y, z;
...
{
    std::ifstream fin("D:\\Winapi\\Software_Rendering\\Software_Rendering\\" + objectName);
    std::string s;
    Object result;
    if(!fin)
    {
    ...
    while(fin >> s)
    {
        ...
        else if(s == "f")
        {
            ...
            Index index = FaceValueToIndex(input1,input2,input3); 
            Index i = index;
